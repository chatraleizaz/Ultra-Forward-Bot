...
class Config:
    ...
    DATABASE_NAME = environ.get("DATABASE_NAME", "default_database_name")  # Add a fallback default name here
    ...
    FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "-1002684943176") 
